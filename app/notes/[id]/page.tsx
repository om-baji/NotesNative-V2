    ...
    return (
        <div>
            ...
            <div className="grid grid-cols-[70%_30%] h-screen">
                <div className="bg-[#1a1f2b] text-white p-6 flex flex-col gap-4">
                    <input
                        placeholder='title'
                        type="text"
                        value={note?.title || ''}
                        disabled={!isEditing}
                        className={`text-4xl font-bold text-[#82aaff] bg-transparent border-none outline-none ${
                    ...
                    <textarea
                        ...
                        disabled={!isEditing}
                        className={`text-lg text-[#c3c9d9] h-96 bg-transparent border-none outline-none resize-none ${
                ...
                <div className="bg-[#1e293b] text-white p-6">
                    <div className="text-2xl font-semibold text-[#82aaff]">
                        User ID: {note?.userId}
                    </div>
                    <div className="text-md text-[#a0aec0] mt-4">
                        Created At: {note?.createdAt ? new Date(note.createdAt).toLocaleString() : 'N/A'}
                    </div>
                    <div className="text-md text-[#a0aec0] mt-2">
